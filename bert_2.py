...
train_encodings = bert_encoder(df_train['sentence'])
dev_encodings = bert_encoder(df_dev['sentence'])
test_encodings = bert_encoder(df_test['sentence'])
...
#swanlab初始化
run = swanlab.init(project="bert_2",experiment_name="bert_2")
#定义训练
