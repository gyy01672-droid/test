...
#swanlab初始化
run = swanlab.init(project="bilstm_10",experiment_name="bilstm_10",config={"hidden_dim":hidden_dim,"learning_rate":learning_rate,"epochs":epochs,"batch_size":batch_size,"max_len":20})
#定义训练函数
